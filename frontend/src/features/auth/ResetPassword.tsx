                    ...
                    {done ? (
                        <div className="text-center">
                            ...
                            <button
                                ...
                                className="apple-btn-primary w-full py-4 text-lg font-semibold flex items-center justify-center gap-2"
                            >
                        ...
                        <>
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="space-y-2">
                                    <label className="text-base font-semibold text-apple-gray-400 ml-1">New Password</label>
                                    ...
                                    <AnimatePresence>
                                        {newPassword.length > 0 && (
                                            ...
                                            >
                                                {passChecks.map((c, i) => (
                                                    <div key={i} className="flex items-center gap-2.5 text-lg">
                                                        {c.passed
                                ...
                                {/* Confirm Password */}
                                <div className="space-y-2">
                                    <label className="text-base font-semibold text-apple-gray-400 ml-1">Confirm Password</label>
                                    <div className="relative">
                                        <Lock className="absolute left-4 top-1/2 -translate-y-1/2 h-4.5 w-4.5 text-apple-gray-300 pointer-events-none" />
                                        <input
                                    ...
                                    {confirmPassword && newPassword !== confirmPassword && (
                                        <p className="mt-1 ml-1 text-sm font-medium text-rose-500">Passwords do not match</p>
                                    )}
                                </div>
