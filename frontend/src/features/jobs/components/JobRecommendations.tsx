...
export default function JobRecommendations() {
    ...
    if (loading) {
        return (
            <div className="p-12 text-center text-slate-400 animate-pulse bg-white rounded-2xl border border-dashed border-slate-200">
    ...
    if (error) {
        return (
            <div className="bg-white border border-red-100 p-8 rounded-2xl flex flex-col items-center text-center gap-4 shadow-sm">
                ...
                <Link to="/resume-upload" className="px-6 py-2 bg-slate-900 text-white rounded-lg hover:bg-slate-800 transition-colors font-medium">
                            ...
                            <div className="flex-1 space-y-4">
                                <div>
                                    <div className="flex items-center gap-3 mb-2">
                                        <div className="h-10 w-10 bg-slate-100 rounded-lg flex items-center justify-center text-slate-700 font-bold border border-slate-200">
                                ...
                                <div className="pt-4 border-t border-slate-100">
                                    <p className="text-xs font-bold text-slate-400 uppercase tracking-wider mb-3">Key Skills Required</p>
                                ...
                                <div className="flex gap-4 pt-2">
                                    ...
                                    <button
                                        ...
                                        className="flex-1 bg-slate-900 text-white py-2.5 rounded-xl font-semibold hover:bg-slate-800 transition-colors shadow-lg shadow-slate-200 active:scale-95"
                                    >
                                        Apply Now
                                    </button>
                                </div>
