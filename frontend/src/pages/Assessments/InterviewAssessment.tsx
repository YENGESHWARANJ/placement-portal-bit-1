    ...
    if (phase === "configure") return (
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}
            ...
            <motion.button whileHover={{ scale: 1.01 }} whileTap={{ scale: 0.98 }}
                ...
                className="w-full py-7 bg-amber-500 text-white rounded-[30px] font-bold text-lg uppercase tracking-[0.2em] shadow-apple-hover flex items-center justify-center gap-4 group">
    ...
    if (phase === "ready") return (
        <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <motion.div className="bg-apple-gray-900 p-10 rounded-[40px] text-white flex flex-col justify-between relative overflow-hidden group">
                    ...
                    <div className="relative z-10">
                        <h4 className="text-[10px] font-bold uppercase tracking-[0.4em] text-amber-500 mb-6">Security Protocol</h4>
                    ...
                    <div className="relative z-10 flex items-center gap-4 mt-10">
                        ...
                        <span className="text-[11px] font-bold text-apple-gray-500 uppercase tracking-widest">Biometric Link Active</span>
                    </div>
                </motion.div>
            </div>
            ...
            <motion.button whileHover={{ scale: 1.01 }} whileTap={{ scale: 0.98 }}
                ...
                className="w-full py-7 bg-apple-blue text-white rounded-[30px] font-bold text-lg uppercase tracking-[0.3em] shadow-apple-hover flex items-center justify-center gap-4 group">
            ...
            <motion.div initial={{ opacity: 0, scale: 0.98 }} animate={{ opacity: 1, scale: 1 }}
                ...
                <div className="bg-white rounded-[50px] shadow-apple-card border border-apple-gray-100 overflow-hidden">
                    <div className="p-14 bg-apple-gray-900 text-white text-center relative overflow-hidden">
                        ...
                        <p className="text-apple-gray-400 font-semibold uppercase tracking-widest text-[10px] relative z-10">
                    ...
                    <div className="p-14 space-y-14">
                        <div className="text-center">
                            ...
                            <p className="text-apple-gray-400 font-bold uppercase tracking-widest text-[11px]">Neural Resonance Score</p>
                        </div>
                                    ...
                                    return (
                                        <div key={cat} className="space-y-2">
                                            <div className="flex justify-between items-end">
                                                <span className="text-[13px] font-bold text-apple-gray-900 uppercase tracking-tight">{cat}</span>
                                                <span className="text-[11px] font-bold text-apple-gray-400">{avgScore.toFixed(1)}/5 ⭐</span>
                                            </div>
        ...
        <div className="min-h-screen bg-apple-gray-50/50 py-8 px-6">
            <div className="max-w-[1440px] mx-auto grid grid-cols-1 lg:grid-cols-12 gap-8">
                ...
                <div className="lg:col-span-3 space-y-6">
                    {/* Timer Card */}
                    <div className="apple-card p-8 bg-apple-gray-900 text-white relative overflow-hidden group">
                        ...
                        <div className="flex items-center gap-3 mb-6 relative z-10">
                            ...
                            <p className="text-[10px] font-bold uppercase tracking-widest text-apple-gray-400">Time Remaining</p>
                        </div>
                        <div className="text-center py-2 relative z-10">
                            <span className={cn("text-5xl font-bold tracking-tight", timeLeft < 120 ? "text-rose-500" : "text-white")}>
                                {fmt(timeLeft)}
                            </span>
                        </div>
                        <div className="h-1.5 bg-white/10 rounded-full overflow-hidden mt-8 relative z-10">
                    ...
                    <div className="apple-card p-8 space-y-6">
                        ...
                        <div className="space-y-4">
                            <div className="flex items-center justify-between">
                                <span className="text-[11px] font-bold text-apple-gray-400 uppercase">Answered</span>
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <div className="p-4 bg-apple-gray-50 rounded-[20px] text-center">
                                ...
                                <div className="text-[9px] font-bold text-apple-gray-400 uppercase tracking-widest">Active</div>
                            </div>
                            <div className="p-4 bg-apple-gray-50 rounded-[20px] text-center">
                                <div className="text-lg font-bold text-apple-gray-900">{questions.length - answeredCount}</div>
                                <div className="text-[9px] font-bold text-apple-gray-400 uppercase tracking-widest">Remaining</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="apple-card p-8">
                        <p className="text-[10px] font-bold uppercase tracking-widest text-apple-gray-400 mb-6">Environment</p>
                        <div className="grid grid-cols-2 gap-4">
                            <motion.button whileHover={{ y: -2 }} whileTap={{ scale: 0.95 }}
                                ...
                                <span className="text-[10px] font-bold uppercase tracking-widest">{micOn ? "Live" : "Muted"}</span>
                            </motion.button>
                            <motion.button whileHover={{ y: -2 }} whileTap={{ scale: 0.95 }}
                                ...
                                <span className="text-[10px] font-bold uppercase tracking-widest">{videoOn ? "On" : "Off"}</span>
                            </motion.button>
                        </div>
                    </div>
                </div>
                    ...
                    <AnimatePresence mode="wait">
                        <motion.div key={currentIndex}
                            ...
                            <div className="flex items-center justify-between shrink-0">
                                ...
                                <span className="text-[11px] font-bold text-apple-gray-400 uppercase tracking-widest">{currentIndex + 1} OF {questions.length}</span>
                            </div>

                            <div className="space-y-4 shrink-0">
                                <p className="text-[11px] font-bold uppercase tracking-[0.2em] text-apple-gray-400">The Problem</p>
                            ...
                            <div className="flex-1 flex flex-col space-y-4">
                                <p className="text-[11px] font-bold uppercase tracking-[0.2em] text-apple-gray-400 flex items-center justify-between">
                                    Your Response
                                    <span className="text-apple-gray-300 font-medium normal-case tracking-normal italic text-[10px]">Auto-saving enabled...</span>
                                </p>
                                <textarea
                                    value={currentAnswer}
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 shrink-0 pt-6">
                                <div className="space-y-4">
                                    <button onClick={() => setShowKeyPoints(!showKeyPoints)}
                                        className="flex items-center gap-3 text-[11px] font-bold text-amber-600 uppercase tracking-widest hover:text-amber-700 transition-colors">
                                            ...
                                            <motion.div initial={{ opacity: 0, height: 0 }} animate={{ opacity: 1, height: "auto" }} exit={{ opacity: 0, height: 0 }}
                                                ...
                                                {currentQ.keyPoints.map((pt, i) => (
                                                    <div key={i} className="flex items-start gap-2">
                                                        ...
                                                        <span className="text-[12px] font-medium text-amber-800/80">{pt}</span>
                                                    </div>
                                                ))}
                                            </motion.div>
                                        )}
                                ...
                                <div className="space-y-4">
                                    <button onClick={() => setShowAnswer(!showAnswer)}
                                        className="flex items-center gap-3 text-[11px] font-bold text-indigo-600 uppercase tracking-widest hover:text-indigo-700 transition-colors">
                                    ...
                                    <AnimatePresence>
                                        {showAnswer && (
                                            <motion.div initial={{ opacity: 0, height: 0 }} animate={{ opacity: 1, height: "auto" }} exit={{ opacity: 0, height: 0 }}
                                                ...
                                                <p className="text-[12px] font-medium text-indigo-900/70 leading-relaxed italic">
                            ...
                            <div className="flex items-center justify-between pt-10 border-t border-apple-gray-100 shrink-0">
                                <div className="flex items-center gap-4">
                                    <p className="text-[10px] font-bold uppercase tracking-widest text-apple-gray-400">Self-Rate</p>
                                    <div className="flex gap-2">
                                        {[1, 2, 3, 4, 5].map(s => (
                                ...
                                <div className="flex items-center gap-3">
                                    <motion.button whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}
                                        ...
                                        className="px-8 py-4 bg-apple-blue text-white rounded-[16px] font-bold text-[11px] uppercase tracking-widest shadow-apple-hover">
                                        Deploy Response
                                    </motion.button>
                                </div>
                            </div>
                ...
                <div className="lg:col-span-3 space-y-6">
                    <div className="apple-card p-8 sticky top-8">
                        ...
                        <div className="mt-10 space-y-4">
                            <div className="flex items-center justify-between">
                                <span className="text-[10px] font-bold text-apple-gray-400 uppercase tracking-widest">Self-Rated</span>
                                <span className="text-xs font-bold text-apple-gray-900">{Object.keys(selfScores).length}</span>
                            </div>
                            <div className="flex items-center justify-between">
                                <span className="text-[10px] font-bold text-apple-gray-400 uppercase tracking-widest">Average ⭐</span>
                        ...
                        <div className="pt-8 border-t border-apple-gray-50 mt-8 space-y-4">
                            <button onClick={handleFinish}
                                className="w-full py-4 bg-apple-gray-900 text-white rounded-[16px] font-bold text-[11px] uppercase tracking-widest shadow-apple-hover flex items-center justify-center gap-2 group">
                                <Zap className="h-4 w-4 text-emerald-500" />
                                Terminate Session
                            </button>
                            <p className="text-center text-[9px] font-bold text-apple-gray-300 uppercase leading-relaxed">
