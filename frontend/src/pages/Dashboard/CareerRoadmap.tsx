                ...
                <div className="relative z-10 flex flex-col lg:flex-row justify-between gap-12">
                    <div className="flex-1 space-y-8">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <h2 className="text-[10px] font-bold text-apple-gray-400 uppercase tracking-widest leading-none">AI Career Compass</h2>
                                <p className="text-[9px] font-black text-apple-blue uppercase tracking-widest mt-1">Cognitive Engine v4.0</p>
                            </div>
                        </div>
                        ...
                        <div className="flex items-center gap-4 max-w-md">
                            ...
                            <motion.button
                                ...
                                className="h-14 w-14 bg-apple-blue text-white rounded-2xl flex items-center justify-center hover:bg-apple-blue-dark transition-all disabled:opacity-50 shadow-apple-hover"
                            >
                    ...
                    <div className="flex flex-col sm:flex-row gap-6 shrink-0">
                        {[
                            ...
                            >
                                ...
                                <p className="text-[10px] font-bold text-apple-gray-400 uppercase tracking-widest mb-3">{stat.label}</p>
                                ...
                                <div className="mt-4 flex items-center gap-1.5">
                                    ...
                                    <span className="text-[8px] font-bold text-apple-gray-300 uppercase tracking-widest">Neural Link</span>
                                </div>
                            </motion.div>
                        ))}
                    </div>
                                    ...
                                    <motion.div
                                        ...
                                        className={cn(
                                            ...
                                            step.status === 'completed' ? "bg-emerald-500 text-white border-emerald-400" :
                                                step.status === 'in-progress' ? "bg-apple-blue text-white border-apple-blue" :
                                        ...
                                        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-6 mb-8">
                                            <div>
                                                ...
                                                <div className="flex items-center gap-2">
                                                    ...
                                                    <p className="text-[10px] font-bold uppercase tracking-[0.3em] text-apple-gray-400">Phase Protocol {idx + 1}</p>
                                                </div>
                                            </div>
                                            <span className={cn(
                                                "w-fit px-6 py-2 rounded-full text-[10px] font-bold uppercase tracking-widest border",
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                            {step.tasks.map((task: string, i: number) => (
                                                ...
                                                >
                                                    ...
                                                    <span className="text-[12px] font-bold text-apple-gray-600 uppercase tracking-tight leading-none">{task}</span>
                                                </div>
                                            ))}
                                        </div>
                                        ...
                                        {step.status === 'in-progress' && (
                                            <div className="mt-12 pt-10 border-t border-apple-gray-50 flex flex-col md:flex-row md:items-center justify-between gap-10">
                                                <div className="flex-1">
                                                    <div className="flex justify-between items-center mb-4">
                                                        <div className="flex items-center gap-2">
                                                            ...
                                                            <p className="text-[10px] font-bold uppercase tracking-[0.4em] text-apple-gray-400">Sync Velocity</p>
                                                        </div>
                                                ...
                                                <button
                                                    ...
                                                    className="flex items-center gap-4 bg-apple-gray-900 text-white px-10 py-5 rounded-[20px] text-[11px] font-bold uppercase tracking-widest hover:scale-[1.02] hover:bg-black transition-all shadow-apple-hover"
                                                >
                                                    Initiate Action
                ...
                <div className="lg:col-span-4 space-y-10">
                    ...
                    >
                        ...
                        <div className="flex items-center justify-between mb-10 relative z-10">
                            <h4 className="text-[11px] font-bold uppercase tracking-[0.4em] text-apple-gray-400">Cognitive Radar</h4>
                        ...
                        <div className="space-y-4 relative z-10">
                            {radarData.slice(0, 3).map((stat, i) => (
                                <div key={i} className="flex items-center justify-between p-4 bg-apple-gray-50/50 rounded-[16px] border border-transparent hover:border-apple-blue/10 transition-all">
                                    <div>
                                        <p className="text-[9px] font-bold text-apple-gray-400 uppercase tracking-widest">{stat.subject}</p>
                    ...
                    <motion.div
                        ...
                        className="p-10 rounded-[40px] bg-apple-gray-900 text-white relative overflow-hidden shadow-2xl group"
                    >
                        ...
                        <div className="relative z-10">
                            <div className="h-16 w-16 bg-white/10 rounded-[20px] flex items-center justify-center mb-10 border border-white/5 shadow-2xl">
                            ...
                            <button
                                ...
                                className="w-full bg-apple-blue text-white py-6 rounded-[24px] font-bold uppercase tracking-widest text-[11px] hover:bg-white hover:text-apple-blue transition-all shadow-apple-hover"
                            >
                                Access Elite Tiers
                            </button>
                        </div>
                    ...
                    <div className="p-10 apple-card border border-apple-gray-50">
                        <div className="flex items-center gap-3 mb-8">
                            ...
                            <h5 className="text-[10px] font-bold uppercase tracking-[0.4em] text-apple-gray-400">System Feed</h5>
                        </div>
                        <div className="space-y-5">
                            {[
                                ...
                                <div key={i} className="flex items-center gap-3 text-[10px] font-bold text-apple-gray-500 uppercase tracking-tight">
