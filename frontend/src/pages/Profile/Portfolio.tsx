        ...
        <div className="animate-in fade-in zoom-in duration-500 pb-20">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
                <div className="bg-white p-6 rounded-3xl shadow-sm border border-slate-100 flex items-center gap-5 group hover:shadow-md transition-all">
                    ...
                    <div>
                        ...
                        <p className="text-xs font-black uppercase tracking-widest text-slate-400">Total Projects</p>
                    </div>
                </div>
                <div className="bg-white p-6 rounded-3xl shadow-sm border border-slate-100 flex items-center gap-5 group hover:shadow-md transition-all">
                    ...
                    <div>
                        ...
                        <p className="text-xs font-black uppercase tracking-widest text-slate-400">GitHub Commits</p>
                    </div>
                </div>
                <div className="bg-white p-6 rounded-3xl shadow-sm border border-slate-100 flex items-center gap-5 group hover:shadow-md transition-all">
                    ...
                    <div>
                        ...
                        <p className="text-xs font-black uppercase tracking-widest text-slate-400">Better Match Chance</p>
                    </div>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    ...
                    <div key={project.id} className="bg-white rounded-3xl border border-slate-100 shadow-sm hover:shadow-2xl transition-all duration-500 overflow-hidden group">
                        ...
                        <div className="h-44 bg-slate-50 relative overflow-hidden group-hover:bg-slate-100 transition-colors">
                            ...
                            <div className="absolute top-4 left-4">
                                <span className="px-3 py-1 bg-white/80 backdrop-blur-md rounded-lg text-[10px] font-black uppercase tracking-widest border border-slate-200 shadow-sm">
                                    {project.category}
                                </span>
                            </div>
                        </div>
                        ...
                        <div className="p-8">
                            ...
                            <div className="flex flex-wrap gap-2 mb-8">
                                {project.tech.map(t => (
                                    <span key={t} className="px-2.5 py-1 bg-slate-50 text-slate-600 rounded-lg text-[10px] font-bold border border-slate-100 uppercase tracking-tight group-hover:border-blue-200 group-hover:bg-blue-50/50 transition-colors">
                                        {t}
                                    </span>
                                ))}
                            </div>
                            ...
                            <div className="flex items-center justify-between pt-6 border-t border-slate-100">
                                <div className="flex gap-2">
                                    <a href={`https://${project.github}`} target="_blank" className="p-2.5 bg-white border border-slate-200 rounded-xl text-slate-400 hover:text-slate-900 hover:border-slate-400 transition-all">
                                        <Github className="h-4 w-4" />
                                    </a>
                                    <a href={`https://${project.live}`} target="_blank" className="p-2.5 bg-white border border-slate-200 rounded-xl text-slate-400 hover:text-blue-600 hover:border-blue-200 transition-all">
                                        <ExternalLink className="h-4 w-4" />
                                    </a>
                                </div>
                                <div className="flex gap-2">
                                    <button className="p-2.5 bg-white border border-slate-200 rounded-xl text-slate-400 hover:text-blue-600 hover:border-blue-200 transition-all">
                                        <Edit2 className="h-4 w-4" />
                                    </button>
                                    <button
                                        onClick={() => handleDelete(project.id)}
                                        className="p-2.5 bg-white border border-slate-200 rounded-xl text-slate-400 hover:text-red-600 hover:border-red-200 transition-all"
                                    >
                ...
                >
                    ...
                    <p className="text-slate-400 text-sm text-center mt-2 px-6">Upload screenshots, source code, and tech specs.</p>
                </div>
            </div>
                ...
                <div className="fixed inset-0 z-50 bg-slate-900/40 backdrop-blur-sm flex items-center justify-center p-6 animate-in fade-in duration-300">
                    <div className="bg-white w-full max-w-lg rounded-3xl shadow-2xl p-8 animate-in zoom-in-95 duration-500">
                        ...
                        <div className="space-y-4 mb-8">
                            ...
                            <div className="space-y-1.5">
                                <label className="text-xs font-black uppercase tracking-widest text-slate-400 ml-1">Live URL</label>
                        ...
                        <div className="flex gap-4">
                            ...
                            <button onClick={() => { setShowModal(false); toast.success("Project added to queue"); }} className="flex-1 px-6 py-3 bg-slate-900 text-white rounded-xl font-bold shadow-xl shadow-slate-200 hover:bg-slate-800 transition-all">Save Project</button>
                        </div>
                    </div>
                </div>
            )}
